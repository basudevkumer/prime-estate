    ...
    >
      ...
      >
        ...
        <div>
          {property.featured && (
            <span
              className="inline-flex px-4 py-2 rounded-full text-xs font-medium bg-blue-500/20 border border-blue-500/30 text-blue-400"
            >
              Featured Property
            </span>
          )}
        ...
        >
          ...
          >
            <button
              className="h-12 px-5 rounded-2xl glass-card flex items-center gap-2"
            >
              <RiHeartLine />
              Save
            </button>
