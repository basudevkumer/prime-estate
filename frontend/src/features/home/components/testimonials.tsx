...
export function Testimonials() {
  return (
    <section className="section-padding relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-violet-500/5 blur-[160px] pointer-events-none" />
      ...
      <div className="container-premium relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="heading-2 font-heading mt-4">What Our Clients Say</h2>
          ...
          {testimonials.map((t) => (
            <SwiperSlide key={t.id}>
              <div className="glass-card p-8 rounded-[32px] h-full">
                ...
                <p className="text-slate-300 leading-relaxed">"{t.review}"</p>
